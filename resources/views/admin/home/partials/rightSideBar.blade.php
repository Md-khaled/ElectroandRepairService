...
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar2.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar3.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar4.jpg')}}" alt="Avatar">
</li>
</ul>
</div>
</li>
...
<li class="m-r-15"><small>Team</small></li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar10.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar9.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar8.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar7.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar6.jpg')}}" alt="Avatar">
</li>
</ul>
</div>
</li>
...
<li class="m-r-15"><small>Team</small></li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar5.jpg')}}" alt="Avatar">
</li>
<li>
<img src="{{asset('storage/app/public/admin_img/xs/avatar2.jpg')}}" alt="Avatar">
</li>
