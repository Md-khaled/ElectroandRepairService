...
<div class="img">
<img src="{{asset('storage/app/public/admin_img/lg/avatar1.jpg')}}" class="rounded-circle" alt="profile-image">
</div>
<div class="user">
...
<li class="left">
<img src="{{asset('storage/app/public/admin_img/xs/avatar3.jpg')}}" class="rounded-circle" alt="">
...
<li class="left">
<img src="{{asset('storage/app/public/admin_img/xs/avatar2.jpg')}}" class="rounded-circle" alt="">
<ul class="list-unstyled chat_info">
...
<li class="left">
<img src="{{asset('storage/app/public/admin_img/xs/avatar5.jpg')}}" class="rounded-circle" alt="">
<ul class="list-unstyled chat_info">
