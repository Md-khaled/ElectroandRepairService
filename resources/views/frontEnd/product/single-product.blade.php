                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="imgs-zoom-area">
                                            <img id="zoom_03" src="{{asset($product->img)}}" data-zoom-image="{{asset($product->img)}}" alt="">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div id="gallery_01" class="carousel-btn slick-arrow-3 mt-30">
                                                        <div class="p-c">
                                                            <a href="#" data-image="{{asset('storage/app/public/users_img/product')}}/1.jpg" data-zoom-image="{{asset('storage/app/public/users_img/product')}}/1.jpg">
                                                                <img class="zoom_03" src="{{asset('storage/app/public/users_img/product')}}/1.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="p-c">
