 <footer id="footer" class="footer-area">
                                ...
                                <div class="col-lg-4 col-md-5 col-sm-4">
                                    <div class="single-footer footer-about">
                                        <div class="footer-logo">
                                            <img src="{{asset('storage/app/public/users_img/logo')}}/logo.png" alt="">
                                        </div>
            ...
            <style type="text/css">
             ...
             <div class="chaticon" id="chat">
                 <img  src="{{asset('storage/app/public/users_img/chat')}}/chat.png" alt="">
             </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <ul class="footer-payment text-right">
                                        <li>
                                            <a href="#"><img src="{{asset('storage/app/public/users_img/payment')}}/1.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('storage/app/public/users_img/payment')}}/2.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('storage/app/public/users_img/payment')}}/3.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('storage/app/public/users_img/payment')}}/4.jpg" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
