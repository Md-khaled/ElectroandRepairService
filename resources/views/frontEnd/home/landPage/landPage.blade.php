                        ...
                        <div class="row active-by-brand slick-arrow-2">
                            ...
                            <div class="col-xs-12">
                                <div class="single-brand-product">
                                    <a href="{{route('user.product.show',$brand->id)}}"><img src="{{url($brand->logo)}}" alt=""></a>
                        ...
                        <div class="row active-featured-product slick-arrow-2">
                                ...
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('storage/app/public/users_img/product')}}/1.jpg" alt=""/>
                                        </a>
                                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('storage/app/public/users_img/product')}}/2.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('storage/app/public/users_img/product')}}/3.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('storage/app/public/users_img/product')}}/4.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="up-comming-pro gray-bg clearfix">
                                <div class="up-comming-pro-img f-left">
                                    <a href="#">
                                        <img src="{{asset('storage/app/public/users_img/up-comming')}}/1.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4 hidden-sm col-xs-12">
                            <div class="banner-item banner-1">
                                ...
                                <div class="banner-img">
                                    <a href="#"><img src="{{asset('storage/app/public/users_img/banner')}}/1.jpg" alt=""></a>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 hidden-sm col-xs-12">
                                        <div class="product-item">
                                            ...
                                            <div class="product-info">
                                                <h6 class="product-title">
                                                    <a href="{{route('user.single_product.show',$product->id)}}">Product Name</a>
                                                </h6>
                                                ...
                                                <ul class="action-button">
                                                    <li>
                                                        <a href="{{route('user.wishList.show',$product->id)}}" title="Wishlist"><i class="zmdi zmdi-favorite"></i></a>
                                                    </li>
                                                    <li>
                                                        <a class="quick_view" href="{{route('user.quick_view.show',$product->id)}}" data-id="{{$product->id}}" data-toggle="modal" title="Quickview"><i class="zmdi zmdi-zoom-in"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" title="Compare"><i class="zmdi zmdi-refresh"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{route('user.cart.show',$product->id)}}" title="Add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                     ...
                                     @empty
                                     <p>Product Not Founddd</p>
                                            <!-- product-item end -->
                                     @endforelse
                                    <!-- product-item end -->
                                </div>
                                <div class="row">   
                                       <button  href="#" type="button" class="btn btn-secondary btn-lg pull-right"><strong>Loading More...</strong></button>
                                 </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/5.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/6.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/12.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/8.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 hidden-sm col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/11.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 hidden-sm col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/10.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/9.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('storage/app/public/users_img/product')}}/7.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                ...
                <div class="container">
                    ...
                    <div class="blog">
                        <div class="row active-blog">
                            ...
                            <div class="col-xs-12">
                                <div class="blog-item">
                                    <img src="{{asset('storage/app/public/users_img/blog')}}/1.jpg" alt="">
                                    <div class="blog-desc">
                            ...
                            <div class="col-xs-12">
                                <div class="blog-item">
                                    <img src="{{asset('storage/app/public/users_img/blog')}}/2.jpg" alt="">
                                    <div class="blog-desc">
                                        <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                        <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                        <div class="read-more">
                            ...
                            <div class="col-xs-12">
                                <div class="blog-item">
                                    <img src="{{asset('storage/app/public/users_img/blog')}}/3.jpg" alt="">
                                    <div class="blog-desc">
                                        <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                        <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                        <div class="read-more">
