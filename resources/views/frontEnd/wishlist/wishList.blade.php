                                                ...
                                                <table class="text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="product-thumbnail">
                                                                <div class="pro-thumbnail-img">
                                                                    <a href="{{route('user.single_product.show',$product->products->id)}}">
                                                                    <img src="{{url($product->products->img)}}" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="pro-thumbnail-info text-left">
                                                                    <h6 class="product-title-2">
                                                                        <a href="{{route('user.single_product.show',$product->products->id)}}">{{$product->products->title}}</a>
                                                                    </h6>
                                                                    <p>Brand: {{$product->products->brand->name}}</p>
                                                                    <p>Model: Grand s2</p>
                                                                    <p> Color: Black, White</p>
                                                                </div>
                                                            </td>
                                                            <td class="product-price">TK{{$product->products->price}}</td>
                                                          
                                                            <td class="product-stock text-uppercase">{{ $product->products->quantity<=0 ? 'Not available': 'in stoct' }}</td>
                                                            <td class="product-add-cart">
                                                                <a href="{{route('user.cart.show',$product->products->id)}}" title="Add To Cart">
                                                                    <i class="zmdi zmdi-shopping-cart-plus"></i>
                                                                </a>
                                                            </td>
                                                            <td class="product-remove">
                                                                <a href="">
                                                                    <form action="{{route('user.wishList.destroy',$product->id)}}" method="post" onsubmit="return confirm('Are you sure?');">
                                                                         @csrf
                                                                         @method('DELETE')
                                                        ...
                                                        @empty
                                                         <p>Your wish list account is empty</p>
                                                                <!-- product-item end -->
                                                         @endforelse
                                                        <!-- tr -->
                                                    </tbody>
